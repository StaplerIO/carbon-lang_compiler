...
pub fn build_function_command(func: &Function, defined_functions: &Vec<FunctionDescriptor>, metadata: &PackageMetadata) -> RelocatableCommandList {
    ...
    let mut result = action_block_builder(&ActionBlock { actions: func.body.clone() }, true, defined_functions, &params, metadata);
